<template>
   <v-container>
      ...
      <v-row class="d-flex justify-center" :class="mobile() ? 'flex-column' : 'flex-row'">
         <c-login-providers></c-login-providers>
         <v-divider
            v-if="mobile()"
            class="ma-3"
            inset
            style="max-width:100%;"
         ></v-divider>
         <v-divider v-if="!mobile()" class="ma-3" inset vertical></v-divider>
         <c-user-pass :is-register="true"></c-user-pass>
      </v-row>
   </v-container>
</template>
